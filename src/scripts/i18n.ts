...
const de: Record<string, string> = {
  ...
  "music.playHint": "Zum Anhören A, Enter oder Leertaste drücken",
...
const en: Record<string, string> = {
  ...
  "music.playHint": "Press A, Enter or Space to listen",
...
const fr: Record<string, string> = {
  ...
  "music.playHint": "Appuyez sur A, Entrée ou Espace pour écouter",
...
const es: Record<string, string> = {
  ...
  "music.playHint": "Pulsa A, Intro o Espacio para escuchar",
